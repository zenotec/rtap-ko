...
//*****************************************************************************
static int
stats_proc_show( struct seq_file *file, void *arg )
{
    stats_t *s = 0;
    stats_t *tmp = 0;
...
//*****************************************************************************
static int
stats_proc_open( struct inode *inode, struct file *file )
{
...
//*****************************************************************************
static int
stats_proc_close( struct inode *inode, struct file *file )
{
...
//*****************************************************************************
static ssize_t
stats_proc_read( struct file *file, char __user *buf, size_t cnt, loff_t *off )
{
...
//*****************************************************************************
static loff_t
stats_proc_lseek( struct file *file, loff_t off, int cnt )
{
...
//*****************************************************************************
static ssize_t
stats_proc_write( struct file *file, const char __user *buf, size_t cnt, loff_t *off )
{
    char cmdstr[256+1] = { 0 };
    int fid = 0;
    int ret = 0;
...
//*****************************************************************************
//*****************************************************************************
const struct file_operations stats_proc_fops =
{
    .owner      = THIS_MODULE,
    .open       = stats_proc_open,
    .release    = stats_proc_close,
    .read       = stats_proc_read,
    .llseek     = stats_proc_lseek,
